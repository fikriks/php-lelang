        ...
        <div class="card-body">
            <form method="POST" action="<?= BASE_URL ?>/pengguna/update/<?= $data['dataPengguna']['id_user'] ?>">
                <div class="form-group row mb-4">
                    <label for="nama-pengguna" class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Nama Pengguna <span
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <input type="text" id="username" name="username" class="form-control"
                            placeholder="Username" value="<?= $data['dataPengguna']['username'] ?>" autocomplete="off"
                            required>
                    </div>
                </div>
                <div class="form-group row mb-4">
                ...
                <div class="form-group row mb-4">
                    <label for="telp" class="col-form-label text-md-right col-12 col-md-3 col-lg-3">No.Telepon <span
                            class="text-danger fw-bold">*</span></label>
                    <div class="col-sm-12 col-md-7">
                        <input type="number" id="telp" name="telp" class="form-control"
                            placeholder="Username" value="<?= $data['dataPengguna']['telp'] ?>" autocomplete="off"
                            required>
                    </div>
                </div>
